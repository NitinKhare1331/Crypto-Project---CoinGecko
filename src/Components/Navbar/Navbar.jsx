        ...
        <div className="navbar text-primary-content w-full bg-[#0d20ba]">
            <div className="navbar-start">
                ...
                <ul
                    ...
                    <li><a className={ theme == "light" ? "text-black" : "text-white" } onClick={() => setCurrency("inr")}>INR</a></li>
                    <li><a className={ theme == "light" ? "text-black" : "text-white" } onClick={() => setCurrency("usd")}>USD</a></li>
                </ul>
                </div>
            </div>
